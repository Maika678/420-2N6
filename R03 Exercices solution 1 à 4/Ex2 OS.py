...
print(f"Q3{'_'*60}")
    ...
    # NOTE : On ne peut pas écrire c:\\Users\\..... parce que ca ne fonctionnerait pas sur votre ordinateur

adresse = f"{user_profile}\\Documents"
os.chdir(adresse)
print(os.getcwd())  
...
os.removedirs('OS-ExercQ6/Sous_repertoire')
os.removedirs('OS-ExercQ5')
