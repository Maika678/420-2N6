...
print(f"Voici le nouveau courriel de l'étudiant: {etudiant['courriel']}")
...
print(f"Dans le terminal on veut: Q6: on a enlevé l'âge de l'étudiant, sa valeur était: {etudiant.pop('age')}")
